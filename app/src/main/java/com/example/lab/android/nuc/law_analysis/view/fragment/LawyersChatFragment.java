    ...
    private void initFloatButton(View view){
        ...
        mAction_c.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                camPicPath = PathUtils.getSavePicPath(getActivity());
                if (Build.VERSION.SDK_INT < 24){
                    ...
                    getActivity().grantUriPermission( "com.example.lab.android.nuc.chat",uri,Intent.FLAG_GRANT_PERSISTABLE_URI_PERMISSION);
