...
public class LawVideoFragment2 extends Fragment implements View.OnClickListener{
    ...
    public static LawVideoFragment2 newInstance(){
        Bundle bundle = new Bundle( );
        LawVideoFragment2 lawVideoFragment2 = new LawVideoFragment2();
        lawVideoFragment2.setArguments( bundle );
        return lawVideoFragment2;
    }
    ...
    private void initJiaozi(){
        ...
        mJiaozis.add( new Jiaozi( "【土地确权】农村户口将全面取消！这4件事抓紧去办，越晚越吃亏！",
                "http://pd35yssng.bkt.clouddn.com/videolib_repo%252F1805%252F03%252FEDFVR59O6%252FSD%252FEDFVR59O6-mobile.mp4" ) );
